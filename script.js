...
function register() {
    request('registration.php', '#registerForm', function (data) {
            ...
            for (var i = 0; i < data.length; ++i) {
                switch (data[i]) {
                    ...
                    case 5:
                        ...
                        break;
                    case 6:
                        document.getElementById('errors').innerHTML += '<div class="err">Failed to add account to database. Please try again later.</div>';
                        break;
                    case 7:
