        ...
        <div class="bg-white shadow rounded overflow-hidden">
            <div class="px-4 pt-0 pb-4 cover">
                <div class="media align-items-end profile-head">
                    <div class="profile mr-3"><img class="profImg rounded mb-2 img-thumbnail" src="profileavatars/1624926477201.jpg" alt="..." ><?php if($_SESSION['loggedin'] && $_SESSION['profName'] == $_SESSION['cat']) : ?><button type="button" id="editBtn" onclick="openEditProfile()" class="btn btn-outline-dark btn-sm btn-block">Edit profile</button></div>
            ...
            <div id="openOverviewForm" class="px-4 py-3">
			 ...
			 <div id="openContactForm" class="brCon px-4 py-3" style="display:none">
            ...
            <div class="py-4 px-4">
                ...
                ?>
                                ...
                                <div class="col-lg-6 pl-lg-1">
                                    <?php echo "<img class='img-fluid rounded shadow-sm' src='uploads/$imgRow->filename'>" ?>
                                </div>
